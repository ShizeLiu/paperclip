  ...
  return (
    <CommandDialog open={open} onOpenChange={(v) => {
      ...
      <CommandList>
        <CommandEmpty>
          {showSearchAll ? (
            <span>
              ...
              {t("commandPalette.noQuickMatchesMiddle")} <span className="font-medium">{t("commandPalette.searchAll")}</span> {t("commandPalette.noQuickMatchesSuffix")}
            </span>
          ) : (
        ...
        {showSearchAll ? (
          <CommandGroup heading={t("app.nav.search")}>
            <CommandItem
        ...
        <CommandGroup heading={t("commandPalette.quickFilters")}>
        ...
        {showPromotedProjects && (
          <>
            <CommandGroup heading={t("app.nav.projects")}>
        ...
        <CommandGroup heading={t("commandPalette.actions")}>
          ...
          {onIssueDetail && fileViewerEnabled && (
            ...
            >
              ...
              {t("commandPalette.openFileInTask")}
        ...
        {visibleIssues.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("app.nav.tasks")}>
        ...
        {agents.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("app.nav.agents")}>
