...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("app.nav.home"), icon: House },
      { type: "link", to: "/issues", label: t("app.nav.tasks"), icon: CircleDot },
      { type: "action", label: t("app.nav.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("app.nav.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
